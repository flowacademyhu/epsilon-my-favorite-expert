...
export class ExpertResourceService {
    ...
    /**
     * findAllFollowersExperts
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public findAllFollowersExpertsUsingGET(observe?: 'body', reportProgress?: boolean): Observable<Array<Expert>>;
    public findAllFollowersExpertsUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Expert>>>;
    public findAllFollowersExpertsUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Expert>>>;
    public findAllFollowersExpertsUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Expert>>(`${this.basePath}/expert/all-followers-expert`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findExpertTestUsingGET(searchparams: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Expert>>;
    public findExpertTestUsingGET(searchparams: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Expert>>>;
    public findExpertTestUsingGET(searchparams: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Expert>>>;
    public findExpertTestUsingGET(searchparams: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (searchparams === null || searchparams === undefined) {
            throw new Error('Required parameter searchparams was null or undefined when calling findExpertTestUsingGET.');
        }
        ...
        return this.httpClient.get<Array<Expert>>(`${this.basePath}/expert/customsearch`,
            {
